...
class TransaksiDetailController extends Controller
{
    public function index()
    {
        ...
        return view('transaksidetail.index', ['transaksidetail' => $transaksidetail]);
    }
    ...
    public function detail(Request $request)
    {
        ...
        return view('transaksidetail.detail', ['transaksi' => $transaksi]);
    }

    public function edit($id)
    {
        $transaksidetail = TransaksiDetail::findOrFail($id);
        return view('transaksidetail.edit', ['transaksidetail' => $transaksidetail]);
    }
