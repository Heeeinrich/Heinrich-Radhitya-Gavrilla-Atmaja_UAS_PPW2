        ...
        <form method="POST" action={{ route('transaksi.store') }}>
            ...
            <div class="d-flex flex-column gap-4 mb-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="" value="{{ old('tanggal_pembelian') }}" required>
                </div>
            </div>
                        ...
                        <div class="accordion-body">
                            <div class="d-flex flex-column gap-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_produk[]" value="{{ old('nama_produk.0') }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Harga Satuan</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" class="form-control" name="harga_satuan[]" value="{{ old('harga_satuan.0') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Jumlah</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" class="form-control" name="jumlah[]" value="{{ old('jumlah.0') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="text" class="form-control" name="subtotal[]" value="{{ old('subtotal.0') }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="item2" class="accordion-collapse collapse" data-bs-parent="#accordionItem">
                        <div class="accordion-body">
                            <div class="d-flex flex-column gap-4 mb-4">
                                <div class="form-group">
                                    <label>Nama Produk</label>
                                    <input type="text" class="form-control" name="nama_produk[]" value="{{ old('nama_produk1') }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Harga Satuan</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" class="form-control" name="harga_satuan[]" value="{{ old('harga_satuan.1') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Jumlah</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="text" class="form-control" name="subtotal[]" value="{{ old('subtotal.1') }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="item3" class="accordion-collapse collapse" data-bs-parent="#accordionItem">
                        <div class="accordion-body">
                            <div class="d-flex flex-column gap-4 mb-4">
                                <div class="form-group">
                                    <label>Nama Produk</label>
                                    <input type="text" class="form-control" name="nama_produk[]" value="{{ old('nama_produk.2') }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Harga Satuan</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" class="form-control" name="harga_satuan[]" value="{{ old('harga_satuan.2') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Jumlah</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" class="form-control" name="jumlah[]" value="{{ old('jumlah.2') }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Subtotal</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Rp</span>
                                        <input type="text" class="form-control" name="subtotal[]" value="{{ old('subtotal.2') }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
